...
This project contains several SQL queries written using PostgreSQL. The goal of the exercise is to practice working with different types of JOINs, combine data from multiple tables, and understand how relational database tables interact.

Each query demonstrates a real-world use case using DVD_rental database with tables such as actor, address, city, country, film, film_actor, film-category, language, customer, rental, inventory, staff, store, payment, and category.
...
- Ability to combine data from many related tables
- Ability to work with one-to-many and many-to-many relationships
- Use of GROUP BY and aggregation functions
- Confidence navigating relational database schemas
